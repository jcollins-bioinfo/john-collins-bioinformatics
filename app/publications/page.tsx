...
export const metadata: Metadata = {
  ...
  description: "Peer-reviewed articles and published conference abstracts by bioinformatics scientist John Patrick Collins.",
  alternates: { canonical: "/publications" },
  openGraph: {
    title: "Publications & Abstracts | John Patrick Collins",
    description: "Peer-reviewed work in DNA engineering and clinical diagnostics, plus published immuno-oncology and transplant abstracts.",
    url: "/publications",
    type: "website",
  },
};
