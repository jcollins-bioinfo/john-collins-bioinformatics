...
import figureFiveCopy from "./figure-05-copy.json";
...
const figureFiveCaption = figureFiveCopy.caption_markdown_lines.join("\n");
const figureFiveAccessibleDescription = figureFiveCopy.accessible_description_markdown_lines.join("\n");
...
export const mainFigures: FigureSpec[] = [
  ...
  },
  {
    id: "fig-5",
    label: "Figure 5",
    title: figureFiveCopy.title,
    role: "supporting",
    image: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_web.png`,
    pdf: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised.pdf`,
    svg: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised.svg`,
    width: 2400,
    height: 3121,
    alt: figureFiveCopy.alt,
    accessibleDescription: figureFiveAccessibleDescription,
    accessibleDescriptionFormat: "markdown",
    caption: figureFiveCaption,
    sourceRun: "CGT_FIGURE_005",
    sourceNotebook: "CGT-FIGURE-005_TCGA_orthogonal_projection.ipynb",
    notebookSha256: "51dee19a0791dfada00fc021649eb19b87789edab728b7afec5be576c25c84f5",
    imageSha256: "6e18d06bdd16b82700dc6b5db3c2221738cd73d7ba7202c5e0cdb4e873324f5a",
    upstreamRuns: ["CGT_TCGA_002"],
    freezeStatus: "Audited replacement release v1 from frozen post-QC score inputs; the upstream raw-score construction formula is not documented in the release.",
    revisionScope: "Descriptive same-cohort TCGA bulk-expression revision. The packaged archived notebook has SHA-256 51dee19a0791dfada00fc021649eb19b87789edab728b7afec5be576c25c84f5; a later larger same-named Drive notebook has unreconciled SHA-256 72d1efabe3dd8c0447817dedae3d6004b47374065eb90f83f9179ad8d525fb81. The release reproduces the figure from frozen score matrices but does not document the upstream expression-plus-registry formula used to construct the raw scores.",
    qaNote: "Exact 183 × 238 mm canvas; 2,400 × 3,121 web PNG; 4,322 × 5,622 RGB publication PNG at nominal 600 dpi; ICC-tagged PNGs; one-page embedded-TrueType PDF with no Type 3 fonts; accessible path-text SVG with one raster tumor-cloud layer; 6.0 pt minimum font; zero geometry violations; all 33 centroid labels present; vector heatmaps and color scales; clean audit status; 13 of 13 determinism comparisons byte-identical.",
    responsiveNote: figureFiveCopy.responsive_presentation_requirement,
    responsivePanels: [
      {
        id: "a",
        label: "Panel a — Bulk TCGA cohort after expression QC",
        src: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_a.png`,
        width: 1200,
        height: 735,
      },
      {
        id: "b",
        label: "Panel b — Within-cohort transforms reduce shared score dependence",
        src: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_b.png`,
        width: 1800,
        height: 557,
        minimumDisplayWidth: 640,
      },
      {
        id: "c",
        label: "Panel c — TCGA-fitted PCA of pooled residual scores",
        src: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_c.png`,
        width: 1800,
        height: 585,
        minimumDisplayWidth: 680,
      },
      {
        id: "d",
        label: "Panel d — Within-cancer-type relative mean score profiles",
        src: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_d.png`,
        width: 2000,
        height: 893,
        minimumDisplayWidth: 820,
      },
      {
        id: "e",
        label: "Panel e — In-sample between-cancer-type variance fraction",
        src: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_e.png`,
        width: 1400,
        height: 904,
        minimumDisplayWidth: 620,
      },
      {
        id: "f",
        label: "Panel f — Residual score dependence remains",
        src: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_f.png`,
        width: 1400,
        height: 865,
        minimumDisplayWidth: 680,
      },
    ...
    sourceRelease: {
      id: "CGT_FIGURE_005_REVISED_V1",
      filename: "CGT_FIGURE_005_revised_reproducibility_package_v1.zip",
      bytes: 10859631,
      sha256: "72e049f26049311ab0cb94ca6430dfbfee781d3fb20d271f3e043da941498d12",
      manifestFilename: "release_manifest.json",
      manifestBytes: 11620,
      manifestSha256: "49fa61da60eb6be13465904fbbd7f0b3425d61295704f584087d01f3ca1db91c",
    },
    releaseAssets: [
      {
        label: "Web PNG",
        role: "Desktop composite, web fallback, and full-resolution web download",
        linkText: "Download Figure 5 web PNG (2,400 × 3,121)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_web.png`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_web.png",
        bytes: 1632051,
        mimeType: "image/png",
      ...
      {
        label: "600-dpi PNG",
        role: "Publication-resolution RGB PNG with embedded ICC profile",
        linkText: "Download Figure 5 600-dpi PNG (4,322 × 5,622)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_600dpi.png`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_600dpi.png",
        bytes: 1868956,
        mimeType: "image/png",
      ...
      {
        label: "Publication PDF",
        role: "One-page embedded-TrueType publication PDF without Type 3 fonts",
        linkText: "Download Figure 5 publication PDF",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised.pdf`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised.pdf",
        bytes: 395816,
        mimeType: "application/pdf",
      ...
      {
        label: "Vector SVG",
        role: "Accessible font-independent vector with one raster tumor-cloud layer",
        linkText: "Download Figure 5 vector SVG",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised.svg`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised.svg",
        bytes: 1037566,
        mimeType: "image/svg+xml",
        ...
        widthMm: 183,
        heightMm: 238,
        viewBox: "0 0 518.740157 674.645669",
      },
      {
        label: "Responsive panel a",
        role: "Narrow-screen panel a fitted to the content width",
        linkText: "Download Figure 5 responsive panel a (1,200 × 735)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_a.png`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_a.png",
        bytes: 148435,
        mimeType: "image/png",
        sha256: "255a966954efd97ef67f9c3e8ddf1fe4b56cd4bd84fd20215f3fccd8a935c961",
        width: 1200,
        height: 735,
      },
      {
        label: "Responsive panel b",
        role: "Narrow-screen panel b in an accessible horizontal scroller",
        linkText: "Download Figure 5 responsive panel b (1,800 × 557)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_b.png`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_b.png",
        bytes: 179072,
        mimeType: "image/png",
        sha256: "e05250400e4e4c25c73f3974dcb5166a91eedbfc776f0ce6875f9f683f7b6366",
        width: 1800,
        height: 557,
      },
      {
        label: "Responsive panel c",
        role: "Narrow-screen panel c in an accessible horizontal scroller",
        linkText: "Download Figure 5 responsive panel c (1,800 × 585)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_c.png`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_c.png",
        bytes: 466714,
        mimeType: "image/png",
        sha256: "c3fb6af6b1586eb4aaf8961211e793ec5b3e4918eef02163a53b2cae91add93a",
        width: 1800,
        height: 585,
      },
      {
        label: "Responsive panel d",
        role: "Narrow-screen panel d in an accessible horizontal scroller",
        linkText: "Download Figure 5 responsive panel d (2,000 × 893)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_d.png`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_d.png",
        bytes: 300945,
        mimeType: "image/png",
        sha256: "013a1d608c70219e77864640252c5d2efef1720533b8b9fa9917d0b03c2a8d97",
        width: 2000,
        height: 893,
      },
      {
        label: "Responsive panel e",
        role: "Narrow-screen panel e in an accessible horizontal scroller",
        linkText: "Download Figure 5 responsive panel e (1,400 × 904)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_e.png`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_e.png",
        bytes: 328198,
        mimeType: "image/png",
        sha256: "a67cafc6e01f59ec24718eba08ecf7de129298872829bda0f05a6615df10c47a",
        width: 1400,
        height: 904,
      },
      {
        label: "Responsive panel f",
        role: "Narrow-screen panel f in an accessible horizontal scroller",
        linkText: "Download Figure 5 responsive panel f (1,400 × 865)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_f.png`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_mobile_panel_f.png",
        bytes: 178089,
        mimeType: "image/png",
        sha256: "749294bc51ce138cd761c775e4c21d19f23a2983e97536a72da1afa7676e5416",
        width: 1400,
        height: 865,
      },
      {
        label: "Complete reproducibility package v1",
        role: "Complete intact audited Figure 5 release package",
        linkText: "Download Figure 5 complete reproducibility package v1 (ZIP)",
        href: `${mainRoot}/CGT_FIGURE_005_revised_reproducibility_package_v1.zip`,
        filename: "CGT_FIGURE_005_revised_reproducibility_package_v1.zip",
        bytes: 10859631,
        mimeType: "application/zip",
        sha256: "72e049f26049311ab0cb94ca6430dfbfee781d3fb20d271f3e043da941498d12",
      ...
      {
        label: "Machine-readable audit",
        role: "Final clean scientific, geometry, format, accessibility, and provenance audit",
        linkText: "Download Figure 5 machine-readable audit (JSON)",
        href: `${mainRoot}/CGT_FIGURE_005_tcga_cancer_type_structure_revised_audit.json`,
        filename: "CGT_FIGURE_005_tcga_cancer_type_structure_revised_audit.json",
        bytes: 6838,
        mimeType: "application/json",
...
export const supplementaryFigures: FigureSpec[] = [
  ...
  },
  {
    ...
    accessibleDescription:
      "Most tumors lie well above the predefined sample-median expression threshold; a small low-expression tail is excluded before the descriptive TCGA cancer-type analysis. This is a sample-level input-quality filter, not an outcome-based exclusion.",
    caption: [
      "Distribution of sample median expression across retained CGT score genes. The vertical line marks the expression-QC threshold applied before the descriptive TCGA cancer-type analysis.",
    ],
    sourceRun: "CGT_FIGURE_005",
    sourceNotebook: "CGT-FIGURE-005_TCGA_orthogonal_projection.ipynb",
    notebookSha256: "51dee19a0791dfada00fc021649eb19b87789edab728b7afec5be576c25c84f5",
  ...
  },
  {
    ...
    width: 1966,
    height: 1578,
    alt: "Line plot of standardized-score variance share for the first five principal components of raw, centered, and pooled leave-one-axis-out residualized TCGA candidate scores.",
    accessibleDescription:
      "Raw standardized scores have a PC1 share of 83.0%. After per-sample centering or pooled leave-one-axis-out residualization, PC1 share falls to 33.2% and 32.2%, respectively. These are expected transform properties, not evidence of deconfounding or validation.",
    caption: [
      "Standardized-score PCA variance-share spectra for raw, per-sample-centered, and pooled leave-one-axis-out residualized TCGA candidate-score matrices. PCA was fitted within TCGA. The reduction of raw PC1 from 83.0% to approximately 32–33% is an expected transform property, not proof that confounding was removed or independent validation.",
    ],
    sourceRun: "CGT_FIGURE_005",
    sourceNotebook: "CGT-FIGURE-005_TCGA_orthogonal_projection.ipynb",
    notebookSha256: "51dee19a0791dfada00fc021649eb19b87789edab728b7afec5be576c25c84f5",
