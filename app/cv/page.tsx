...
export default function CvPage() {
  return (
    <main id="top" className="interior-page cv-page">
      ...
      <section className="resume-panel shell"><p className="eyebrow"><span /> Full professional record</p><h2>View or keep a copy.</h2><div className="hero-actions"><a className="button primary" href="/John-Patrick-Collins_MSc_Senior%20Bioinformatics_Resume.pdf">View résumé <span aria-hidden="true">↗</span><span className="sr-only"> (PDF)</span></a><a className="button secondary" href="/John-Patrick-Collins_MSc_Senior%20Bioinformatics_Resume.pdf" download>Download résumé (PDF) <span aria-hidden="true">↓</span></a></div></section>
